let GameGrid = (function () {
  ...
  GameGridFactory.prototype.generateTile = function() {
    ...
    if (emptyCells.length > 0) {
      ...
      document.querySelector('#filled-grid').appendChild(tile);
  ...
  GameGridFactory.prototype.moveTile = function(from, to, mergeValue) {
    ...
    if (mergeValue != emptyCellValue) {
      ...
      let removeNode = document.querySelector('#filled-grid .tile[data-cell-no="' + to + '"]');
      document.querySelector('#filled-grid').removeChild(removeNode);
    }
